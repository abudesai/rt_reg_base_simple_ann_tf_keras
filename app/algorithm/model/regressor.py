...
MODEL_NAME = "reg_base_simple_ann"
...
class Regressor(): 
    ...
    def __init__(self, D, l1_reg=1e-6, l2_reg=1e-6, lr = 1e-2, activation = 'relu', **kwargs) -> None:
    ...
    def build_model(self): 
        ...
        x = input_
        x = Dense(max(2, self.D//3), activity_regularizer=reg, activation=self.activation )(x)
    ...
    def load(cls, model_path): 
        ...
        elasticnet.model.load_weights(os.path.join(model_path, model_wts_fname)).expect_partial()
        return elasticnet
